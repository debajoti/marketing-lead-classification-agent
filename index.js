...
async function chat() {
    ...
    try {
      ...
      let responseJson;
      try {
          responseJson = JSON.parse(reply);
          console.log(`Assistant: ${responseJson.content}`);
      } catch (err) {
        console.log("Invalid JSON response from model.");
        return chat();
      }
...
console.log("Assistant: Hi there! Welcome to GrowEasy. How can I help you with your property search?");
chat();
